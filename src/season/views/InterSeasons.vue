...
const specialitiesText = t("seasons.season.interSeason.specialties");

const advicesList: Accordion[] = tm("seasons.season.interSeason.advices");
</script>
